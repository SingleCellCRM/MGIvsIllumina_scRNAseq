...
#$ -t 1-12 #IMPORTANT: change to 1-num_of_samples
...
# each read is a job
ids="/exports/eddie/scratch/$USER/MGI/data/cropped_RT_reads_paths.txt"
...
reformat.sh in=$read1 in2=$read2 out=$out/${read_basename1}.fastq.gz out2=$out/${read_basename2}.fastq.gz samplereadstarget=150m
