...
IDFILE="/exports/eddie/scratch/$USER/MGI/data/ids_TH.txt"
...
FASTQS="/exports/eddie/scratch/$USER/MGI/data/cropped/illumina/David"
# Path to where you want the cellranger output
OUT="/exports/eddie/scratch/$USER/MGI/outs/cellranger/illumina/David"
