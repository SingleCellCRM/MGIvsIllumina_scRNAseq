...
#$ -t 1-6 #IMPORTANT: change to 1-num_of_samples
...
IDFILE="/exports/eddie/scratch/$USER/MGI/data/ids_all_ZB.txt"
...
REFGENOME="/exports/eddie/scratch/$USER/MGI/data/ref_genome/Danio_rerio_refgenome_kaede"
# Path to the directory where the samples are
FASTQS="/exports/eddie/scratch/$USER/MGI/data/cropped/downsampled/"
# Path to where you want the cellranger output
OUT="/exports/eddie/scratch/$USER/MGI/outs/cellranger/downsampled"
