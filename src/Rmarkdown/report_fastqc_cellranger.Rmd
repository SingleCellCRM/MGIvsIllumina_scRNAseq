...
```
TO do:
- global correlation genes
- individual genes picked ( the ones for annotation)  
    - feature plots
    - umap plots with neurons etc marked. How many cells per cluster
- top 20% expression correlation, and bottom 20% correlation (maybe)
