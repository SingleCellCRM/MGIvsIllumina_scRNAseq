...
colnames(rowData(sce_mgi))[4:5] <- paste0(colnames(rowData(sce_mgi))[4:5], "_mgi")
colnames(rowData(sce_illumina))[4:5] <- paste0(colnames(rowData(sce_illumina))[4:5], "_Illumina")
...
rowData(sce) <-  cbind(rowData(sce_mgi), rowData(sce_illumina)[4:5])
...
# plotting will need to wait after normalisation
